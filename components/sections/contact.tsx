      ...
      <div className="relative overflow-hidden py-24">
        ...
        <div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="mb-16 px-4 text-left lg:px-0 lg:text-center">
            ...
            <p className="max-w-none text-lg text-pretty text-foreground lg:mx-auto lg:max-w-2xl">Scrivici e ti aiutiamo a scegliere il percorso piu adatto a te all&apos;Imperial Ballet. Ti rispondiamo con orari, disponibilita e prossimi passi per iniziare.</p>
          </div>
            ...
            <div className="space-y-8">
              <div>
                ...
                <div className="space-y-4">
                  ...
                  <ContactLink href={brand.facebookHref} icon={<MessageCircle className="mt-1 h-6 w-6 flex-shrink-0 text-primary transition-transform group-hover:scale-110" />} label="Facebook" value="Imperial Ballet Official" />
                </div>
              </div>
            </div>
          </div>
